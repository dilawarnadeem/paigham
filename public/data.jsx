export const headerSlider = [
  ...
  {
    hadith:
      "قربانی کا دن، سب دنوں سے افضل ہے رسول اللہﷺ نے فرمایا: ’’اللہ تعالیٰ کے نزدیک سب دنوں میں سے افضل دن قربانی کا دن(10 ذوالحجہ) ہے اور اس کے بعد پسندیدہ دن یَوْمُ الْقَرِّ(11ذوالحجہ) ہے۔ (سنن ابوداؤد: 1765، بروایت: سیدنا عبداللہ بن قُرطْ)",
  },
  {
    hadith:
      "قربانی نہ کرنے والے کو تنبیہ رسول اللہﷺنے فرمایا: ’’استطاعت کے باوجود قربانی نہ کرنے والا ہماری عید گا ہ کےقریب نہ آئے۔‘‘ (سنن ابن ماجہ :3123، بروایت: سیدنا ابو ہریرہ)",
  },
  {
    hadith:
  ...
  {
    hadith:
      "مشکل ہو تو اونٹ میں 10 حصے سیدنا ابن عباس روایت کرتے ہیں:’’ہم رسول اللہﷺ کےساتھ سفرمیں تھے،کہ عید الاضحیٰ آ گئی، اس وقت ہم گائےکی قربانی میں 7 لوگ اور اونٹ کی قربانی میں 10 اَفراد شریک ہوئے۔‘‘ (جامع ترمذی :905، بروایت: سیدنا ابن عباس)",
  },
  {
    hadith:
  ...
  {
    hadith:
      "عورت بھی ذبح کر سکتی ہے ایک عورت نے تیز دھار پتھر سے بکری ذبح کر دی، رسول اللہﷺسے اس بارےمیں پوچھا گیاتوآپﷺ نے اسے کھانے کی اجازت دے دی۔ (صحیح بخاری :5504، بروایت: سیدنا کعب بن مالک)",
  },
  {
    hadith:
  ...
  {
    hadith:
      "قربانی کی کھال کا مصرف رسول اللہﷺنے فرمایا: ’’جس نے اپنی قربانی کی کھال فروخت (کر کے قیمت خود استعمال کر لی) اس کی کوئی قربانی نہیں۔‘‘ (البتہ بیچے بغیرکھال ذاتی استعمال میں لائی جا سکتی ہے، مثلًا جائے نماز یا مشکیزہ وغیرہ بنالینا۔) (سنن بیہقی: 19233، بروایت: سیدنا ابوہریر)",
  },
];
