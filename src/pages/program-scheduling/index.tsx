          ...
          <div className="md:w-[40%] mt-5 md:mt-0">
            ...
            <div className="font-semibold flex justify-between sm:text-xl tracking-widest item-center">
              ...
              <Link href="/program-scheduling">
                <h5 className="text-primary">FULL GUIDE</h5>
              </Link>
            </div>
            <ul className="mt-5 ">
              {programs.map((item: any, idx: number) => (
                <li
                  key={idx}
                  className="flex gap-x-3 md:gap-x-8 border-t-[1px] border-gray-300 py-5"
                >
                  ...
                  >
                    ...
                    <div
                      className="text-start text-lg mt-2"
...
export default function Program_Scheduling({ allProgramsScheduling }: any) {
  return (
    <>
      <SeoMeta
        title="Program Scheduling | Paigham TV"
        url="/program-scheduling"
