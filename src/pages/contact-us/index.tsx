...
export default function Contact_Us() {
  return (
    <>
      <SeoMeta
        title="Contact Us  For Preaching The True Teachings | Paigham Tv | Paigham TV"
        url="/contact-us"
        description="Contact Us for preaching the true teachings of the Holy Quran and Sunnah "
      />
